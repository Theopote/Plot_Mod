...
public class TextTool extends BaseTool {
    ...
    public void convertTextToGraphics() {
        ...
        List<com.plot.core.model.Shape> graphics = activeText.convertToGraphics();
        if (!graphics.isEmpty()) {
    ...
    public void commit() {
        ...
        if (previewShape instanceof TextShape textShape) {
            // 将文字转换为图形路径
            List<com.plot.core.model.Shape> graphics = textShape.convertToGraphics();
            ...
            if (!graphics.isEmpty()) {
                ...
                try {
                    ...
                    // 添加转换后的图形到图层
                    for (com.plot.core.model.Shape graphic : graphics) {
                        // 确保图形有样式
    ...
    private void executeShapeReplaceCommand(List<com.plot.core.model.Shape> oldShapes,
                                            List<com.plot.core.model.Shape> newShapes,
                                            String actionName) {
        try {

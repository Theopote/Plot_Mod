...
public class SemicircleTool extends DrawingTool {
    ...
    private final com.plot.ui.tools.snap.SnapEnhancer snapEnhancer =
            new com.plot.ui.tools.snap.SnapEnhancer("SemicircleTool");
     ...
     * 支持两种绘制模式的多点点击交互
     */
    private class SemicircleInteractionStrategy implements com.plot.ui.tools.impl.drawing.strategy.IInteractionStrategy {

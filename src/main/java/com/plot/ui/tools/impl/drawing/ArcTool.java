...
public class ArcTool extends DrawingTool {
    ...
    private final com.plot.ui.tools.snap.SnapEnhancer snapEnhancer =
            new com.plot.ui.tools.snap.SnapEnhancer("ArcTool");
     ...
     * 支持三种绘制模式的多点点击交互
     */
    private class ArcInteractionStrategy implements com.plot.ui.tools.impl.drawing.strategy.IInteractionStrategy {

...
import com.plot.core.graphics.style.DefaultStyleConfig;
...
public class StyleHandler implements IStyleHandler {
    ...
    private ShapeStyle createLayerBasedStyle(ILayer currentLayer) {
        if (currentLayer != null) {
            ...
            try {
                if (appState instanceof com.plot.core.state.AppState state) {
                    com.plot.core.layer.LayerManager layerManager = state.getLayerManager();

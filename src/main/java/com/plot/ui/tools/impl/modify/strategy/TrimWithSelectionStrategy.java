    ...
    private List<Shape> calculateTrimmedShapes(Shape targetShape, Vec2d clickPos, List<Shape> boundaryShapes, ModifyToolContext context) {
        try {
            ...
            if (trimHandler == null) {
                ...
                trimHandler = new TrimHandler((com.plot.core.state.AppState) context.getAppState());
    ...
    private void updateBoxSelection(ModifyToolContext context) {
        ...
        for (Shape shape : allShapes) {
            if (shape != null && shape.isVisible() && !shape.isDeleted()) {
                ...
                if (com.plot.ui.tools.impl.modify.helper.GeometricSelectionHelper.isShapeInRectangleSelection(shape, boxStartPoint, boxCurrentPoint, isLeftToRight)) {

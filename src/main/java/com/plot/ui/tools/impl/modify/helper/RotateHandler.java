...
import com.plot.core.command.commands.CopyRotateCommand;
...
public class RotateHandler implements IModifyHandler {
    ...
    public IModifyHandler.ModifyParameters applyConstraints(IModifyHandler.ModifyParameters parameters, 
        ...
        if (constraints == null || !(parameters instanceof com.plot.ui.tools.impl.modify.dto.ModifyParameters params)) {
            return parameters;
        }
        ...
        if (constraints instanceof com.plot.ui.tools.impl.modify.constants.ModifyConstraints concreteConstraints) {
            if (concreteConstraints.isAngleConstraintEnabled()) {
                ...
                if (angleStep > 0) {
                    ...
                    // 创建新的参数对象
                    com.plot.ui.tools.impl.modify.dto.ModifyParameters constrainedParameters = params.clone();

...
public class ThemeManager {
    private static final Logger LOGGER = LoggerFactory.getLogger("Plot/ThemeManager");
     ...
     * 主题仅通过 PlotStyleScope.pushThemeToStack() 在每帧渲染时临时 push，渲染后 pop。
    ...
    */
    ...
    /**
     * 将当前主题 push 到 ImGui 样式栈（用于 PlotStyleScope 实现模组间样式隔离）。

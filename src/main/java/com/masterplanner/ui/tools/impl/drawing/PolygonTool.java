...
public class PolygonTool extends DrawingTool {
    ...
    private final com.masterplanner.ui.tools.snap.SnapEnhancer snapEnhancer =
            new com.masterplanner.ui.tools.snap.SnapEnhancer("PolygonTool");
    ...
    private static final float SNAP_INDICATOR_SIZE = com.masterplanner.ui.tools.snap.SnapVisualStyle.DEFAULT_RING_SIZE;   // 吸附指示器大小
    ...
    private static final Color SNAP_INDICATOR_COLOR = com.masterplanner.ui.tools.snap.SnapVisualStyle.DEFAULT_HIGHLIGHT;
    ...
    @Deprecated
    public PolygonTool() {
        this(com.masterplanner.core.state.AppState.getInstance(), 
             com.masterplanner.core.snap.SnapManager.getInstance());
    }
     ...
     * 支持三种绘制模式的多点点击交互
     */
    private class PolygonInteractionStrategy implements com.masterplanner.ui.tools.impl.drawing.strategy.IInteractionStrategy {

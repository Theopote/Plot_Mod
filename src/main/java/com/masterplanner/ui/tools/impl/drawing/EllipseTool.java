 ...
 * 3. 两点模式：绘制矩形内切椭圆
 */
public class EllipseTool extends DrawingTool implements com.masterplanner.infrastructure.event.EventListener {
    ...
    private final com.masterplanner.ui.tools.snap.SnapEnhancer snapEnhancer =
            new com.masterplanner.ui.tools.snap.SnapEnhancer("EllipseTool");
     ...
     */
    @Override
    public void onEvent(com.masterplanner.infrastructure.event.base.Event event) {
     ...
     * 支持三种绘制模式的多点点击交互
     */
    private class EllipseInteractionStrategy implements com.masterplanner.ui.tools.impl.drawing.strategy.IInteractionStrategy {

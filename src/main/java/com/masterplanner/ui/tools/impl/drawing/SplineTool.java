...
import com.masterplanner.ui.tools.impl.drawing.strategy.ThroughPointsSplineStrategy;
import com.masterplanner.ui.tools.impl.drawing.strategy.ControlPolygonSplineStrategy;
import com.masterplanner.ui.tools.event.SplineConfigChangedEvent;
...
public class SplineTool extends DrawingTool {
    ...
    private final com.masterplanner.ui.tools.snap.SnapEnhancer snapEnhancer =
            new com.masterplanner.ui.tools.snap.SnapEnhancer("SplineTool");
    ...
    public IToolConfig getConfig() {
        return new com.masterplanner.ui.tools.impl.drawing.config.BaseToolConfigAdapter() {
            @Override

...
import com.masterplanner.ui.tools.impl.drawing.helper.PenDrawModeHandler;
import com.masterplanner.ui.tools.impl.drawing.helper.EditModeHandler;
...
public class PolylineTool extends DrawingTool {
    ...
    private class PolylineInteractionStrategy implements com.masterplanner.ui.tools.impl.drawing.strategy.IInteractionStrategy {
                    ...
                    if (appState != null) {
                        try {
                            ...
                            if (appState instanceof com.masterplanner.core.state.AppState) {
                                snapTargets = ((com.masterplanner.core.state.AppState) appState).getShapes();
                            } else {
                                // 兼容性处理：尝试通过反射获取
    ...
    private class ReusableImGuiAdapter implements DrawingAdapter, IModeHandler.DrawingAdapter {
        ...
        private final com.masterplanner.ui.tools.snap.SnapEnhancer snapEnhancer =
                new com.masterplanner.ui.tools.snap.SnapEnhancer("PolylineTool");

...
public final class PenConstants {
    ...
    // 曲率控制常量
    public static final double CURVATURE_INFLUENCE = 0.3;
    public static final double MIN_DISTANCE_THRESHOLD = 1e-6;
    
    // 绘制相关常量
    public static final int MIN_POINTS_FOR_COMPLETION = 2;
    public static final int MIN_POINTS_FOR_CURVE = 2;

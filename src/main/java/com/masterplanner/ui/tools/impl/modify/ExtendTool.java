...
public class ExtendTool extends ModifyTool {
    ...
    protected IModifyStrategy createStrategy() {
        ...
        if (iAppState instanceof com.masterplanner.core.state.AppState concreteAppState) {
            ...
            // 回退到全局单例，但添加警告
            ExtendWithSelectionStrategy strategy = new ExtendWithSelectionStrategy(com.masterplanner.core.state.AppState.getInstance());
     ...
     */
    @Deprecated
    public com.masterplanner.api.geometry.Vec2d getPreviewExtendPoint() {
     ...
     */
    @Deprecated
    public com.masterplanner.api.geometry.Vec2d getPreviewTargetPoint() {
    ...
    public record ExtendToolState(
        ...
        Shape previewTarget,
        com.masterplanner.api.geometry.Vec2d previewExtendPoint,
        com.masterplanner.api.geometry.Vec2d previewTargetPoint,

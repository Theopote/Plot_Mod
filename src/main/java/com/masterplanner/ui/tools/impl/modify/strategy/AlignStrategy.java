...
public class AlignStrategy implements IModifyStrategy {
    ...
    // 预览辅助线：S1->T1, S2->T2
    private List<com.masterplanner.ui.tools.impl.modify.helper.AlignmentGuide> previewGuides = new ArrayList<>();
    ...
    private void createPreviewShapesFromModified(List<Shape> modifiedShapes) {
        ...
        for (Shape shape : modifiedShapes) {
            try {
                // 设置预览样式
                shape.setStyle(com.masterplanner.core.graphics.style.ShapeStyle.PREVIEW);
     ...
     * 获取当前的预览辅助线
     */
    public List<com.masterplanner.ui.tools.impl.modify.helper.AlignmentGuide> getPreviewGuides() {
     ...
     * @return 对齐辅助线列表
     */
    public List<com.masterplanner.ui.tools.impl.modify.helper.AlignmentGuide> getAlignmentGuides() {
     ...
     * @return 参考点信息
     */
    public com.masterplanner.ui.tools.impl.modify.helper.ReferencePointInfo getReferencePointInfo() {
        if (shapesToMove.isEmpty()) {
            return null;
        }

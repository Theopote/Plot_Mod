...
public class ScaleStrategy implements IModifyStrategy {
    ...
    public ModifyResult onMouseDown(Vec2d pos, int button, ModifyToolContext context) {
        ...
        try {
            ...
            if (scaleHandler == null) {
                ...
                if (context.getAppState() instanceof com.masterplanner.core.state.AppState) {
                    scaleHandler = new ScaleHandler((com.masterplanner.core.state.AppState) context.getAppState());
                } else {
    ...
    private Vec2d calculateSelectionCenter(List<Shape> shapes) {
        ...
        com.masterplanner.core.geometry.BoundingBox totalBounds = 
            com.masterplanner.core.geometry.BoundingBox.createFromShapes(shapes);

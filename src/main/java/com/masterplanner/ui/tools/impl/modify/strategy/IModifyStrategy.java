...
public interface IModifyStrategy {
     ...
     * @param context 绘制上下文
     */
    default void renderPreview(com.masterplanner.core.graphics.DrawContext context) {
        // 默认实现为空，子类可以重写
    }
     ...
     * @param camera 画布相机
     */
    default void renderPreview(imgui.ImDrawList drawList, com.masterplanner.ui.canvas.CanvasCamera camera) {
        // 默认实现为空，子类可以重写
    }
    ...
    interface ModifyToolContext {
         ...
         * @return 吸附处理器
         */
        com.masterplanner.ui.tools.impl.drawing.helper.ISnapHandler getSnapHandler();
        
        /**
         * 获取样式处理器
         * @return 样式处理器
         */
        com.masterplanner.ui.tools.impl.drawing.helper.IStyleHandler getStyleHandler();
        
        /**
         * 获取相机
         * @return 相机对象
         */
        com.masterplanner.ui.canvas.CanvasCamera getCamera();
        
        /**
         * 获取画布
         * @return 画布对象
         */
        com.masterplanner.api.model.ICanvas getCanvas();
        
        /**
         * 获取应用状态
         * @return 应用状态对象
         */
        com.masterplanner.api.state.IAppState getAppState();
        
        /**
         * 获取控制点编辑工具
         * @return 控制点编辑工具，如果没有则返回null
         */
        com.masterplanner.ui.tools.impl.modify.ControlPointEditTool getControlPointEditTool();

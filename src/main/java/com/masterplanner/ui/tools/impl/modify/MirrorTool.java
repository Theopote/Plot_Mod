...
public class MirrorTool extends ModifyTool {
     ...
     * 优化的预览图形渲染
     */
    private void renderPreviewShapesOptimized(DrawContext context, java.util.List<com.masterplanner.core.model.Shape> previewShapes) {
        // 限制渲染数量以避免性能问题
    ...
    private void drawAxisPoint(DrawContext context, Vec2d point) {
        double size = 3.0;
        com.masterplanner.api.geometry.Vec2d topLeft = new com.masterplanner.api.geometry.Vec2d(point.x - size, point.y - size);

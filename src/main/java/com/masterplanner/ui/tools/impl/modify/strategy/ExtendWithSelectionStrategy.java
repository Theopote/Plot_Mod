...
public class ExtendWithSelectionStrategy extends BaseSelectionStrategy implements IModifyStrategy {
    ...
    private com.masterplanner.core.spatial.SpatialIndex boundarySpatialIndex; // 边界空间索引
     ...
     */
    public ExtendWithSelectionStrategy(com.masterplanner.core.state.AppState appState) {
    ...
    private void updateBoxSelection(ModifyToolContext context) {
        ...
        for (Shape shape : allShapes) {
            if (shape != null && shape.isVisible() && !shape.isDeleted()) {
                // 根据框选方向选择不同的选择逻辑
                if (com.masterplanner.ui.tools.impl.modify.helper.GeometricSelectionHelper.isShapeInRectangleSelection(
    ...
    private void cacheBoundaryShapes(ModifyToolContext context) {
        try {
            ...
            // 尝试获取空间索引并创建子集
            try {
                com.masterplanner.core.spatial.SpatialIndex mainSpatialIndex = null;
                // 尝试从AppState获取空间索引
                if (context.getAppState() instanceof com.masterplanner.core.state.AppState appState) {
     ...
     */
    private com.masterplanner.core.spatial.SpatialIndex createBoundarySpatialIndex(List<Shape> boundaries) {
        try {
            ...
            // 计算所有边界图形的总包围盒
            com.masterplanner.api.geometry.IBoundingBox bounds = calculateBoundaryBounds(boundaries);
            if (bounds == null) {
            ...
            // 创建四叉树空间索引
            com.masterplanner.core.spatial.SpatialIndex boundaryIndex =
                new com.masterplanner.core.spatial.QuadtreeSpatialIndex(bounds);
     ...
     */
    private com.masterplanner.api.geometry.IBoundingBox calculateBoundaryBounds(List<Shape> boundaries) {
        try {
            if (boundaries == null || boundaries.isEmpty()) {
                return null;
            }
            ...
            com.masterplanner.core.geometry.BoundingBox baseBounds =
                com.masterplanner.core.geometry.BoundingBox.createFromShapes(boundaries);
    ...
    private double calculateDynamicTolerance(Shape shape, Vec2d startEndpoint, Vec2d endEndpoint) {
        try {
            ...
            } else if (shape instanceof com.masterplanner.core.geometry.shapes.CircleShape circle) {
                // 圆形不支持延伸，但为了完整性
    ...
    private Vec2d calculateExtendDirection(Shape shape, Vec2d extendPoint, boolean isStartEndpoint) {
        try {
            ...
            if (shape instanceof com.masterplanner.core.geometry.shapes.LineShape lineShape) {
            ...
            if (shape instanceof com.masterplanner.core.geometry.shapes.PolylineShape polylineShape) {

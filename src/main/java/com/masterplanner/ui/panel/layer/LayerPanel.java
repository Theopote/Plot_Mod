...
public class LayerPanel implements UIComponent {
    ...
    private void subscribeToEvents() {
        ...
        EventListener createdListener = event -> {
            if (event instanceof com.masterplanner.core.layer.LayerEventSystem.LayerCreatedEvent) {
        ...
        EventListener contentChangedListener = event -> {
            if (event instanceof com.masterplanner.core.layer.LayerEventSystem.LayerContentChangedEvent) {
                layerListRenderer.invalidateContentHeight();
            }
        };

        // 注册事件监听器
        eventBus.subscribe(com.masterplanner.core.layer.LayerEventSystem.LayerCreatedEvent.class, createdListener);
        eventBus.subscribe(com.masterplanner.core.layer.LayerEventSystem.LayerContentChangedEvent.class, contentChangedListener);
        eventListeners.put(com.masterplanner.core.layer.LayerEventSystem.LayerCreatedEvent.class, createdListener);
        eventListeners.put(com.masterplanner.core.layer.LayerEventSystem.LayerContentChangedEvent.class, contentChangedListener);
    }
        ...
        if (!texturesInitialized) {
            try {
                ...
                TEXTURE_EYE = textureManager.loadTexture(
                    Identifier.of("masterplanner", "textures/gui/layer/eye.png"));
                TEXTURE_EYE_SLASH = textureManager.loadTexture(
                    Identifier.of("masterplanner", "textures/gui/layer/eye_slash.png"));
                TEXTURE_NEW_LAYER = textureManager.loadTexture(
                    Identifier.of("masterplanner", "textures/gui/layer/new_layer.png"));
                TEXTURE_DELETE_LAYER = textureManager.loadTexture(
                    Identifier.of("masterplanner", "textures/gui/layer/delete_layer.png"));
                TEXTURE_MERGE_LAYERS = textureManager.loadTexture(
                    Identifier.of("masterplanner", "textures/gui/layer/merge_layers.png"));
                TEXTURE_MOVE_UP = textureManager.loadTexture(
                    Identifier.of("masterplanner", "textures/gui/layer/move_up.png"));
                TEXTURE_MOVE_DOWN = textureManager.loadTexture(
                    Identifier.of("masterplanner", "textures/gui/layer/move_down.png"));
                TEXTURE_SELECT_ALL = textureManager.loadTexture(
                    Identifier.of("masterplanner", "textures/gui/layer/select_all.png"));

...
import com.masterplanner.ui.tools.impl.drawing.ArcTool;
import imgui.ImGui;
...
public class ArcToolOptionRenderer extends AbstractToolOptionRenderer {
    ...
    public ArcToolOptionRenderer() {
        ...
        this.startEndDirectionIconId = ImGuiUtils.getTextureId(
            Identifier.of("masterplanner", "textures/gui/tooloptionspanel/arc_start_end_direction.png"));
        this.throughPointIconId = ImGuiUtils.getTextureId(
            Identifier.of("masterplanner", "textures/gui/tooloptionspanel/arc_through_point.png"));
        this.centerStartEndIconId = ImGuiUtils.getTextureId(
            Identifier.of("masterplanner", "textures/gui/tooloptionspanel/arc_center_start_end.png"));
    }

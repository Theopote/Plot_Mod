...
public class CircleToolOptionRenderer extends AbstractToolOptionRenderer {
    ...
    public CircleToolOptionRenderer() {
        ...
        this.circleRadiusIconId = ImGuiUtils.getTextureId(
            Identifier.of("masterplanner", "textures/gui/tooloptionspanel/circle_radius.png"));
        this.circleTwoPointsIconId = ImGuiUtils.getTextureId(
            Identifier.of("masterplanner", "textures/gui/tooloptionspanel/circle_two_points.png"));
        this.circleThreePointsIconId = ImGuiUtils.getTextureId(
            Identifier.of("masterplanner", "textures/gui/tooloptionspanel/circle_three_points.png"));
    }
    ...
    private void renderModeButton(int iconId, String mode, String tooltip, float xPos) {
        ...
        if (isSelected) {
            ...
            com.masterplanner.ui.theme.UITheme.ThemeColors theme = com.masterplanner.ui.theme.ThemeManager.getInstance().getCurrentTheme();

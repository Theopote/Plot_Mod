...
import com.masterplanner.ui.tools.impl.modify.ArrayTool;
import com.masterplanner.ui.tools.impl.modify.strategy.ArrayWithSelectionStrategy;
...
public class ArrayToolOptionRenderer extends AbstractToolOptionRenderer {
    ...
    public ArrayToolOptionRenderer() {
        ...
        this.rectangularArrayIconId = ImGuiUtils.getTextureId(
            Identifier.of("masterplanner", "textures/gui/tooloptionspanel/array_rectangular.png"));
        this.circularArrayIconId = ImGuiUtils.getTextureId(
            Identifier.of("masterplanner", "textures/gui/tooloptionspanel/array_circular.png"));
        this.pathArrayIconId = ImGuiUtils.getTextureId(
            Identifier.of("masterplanner", "textures/gui/tooloptionspanel/array_path.png"));

...
import com.masterplanner.ui.tools.impl.modify.BreakTool;
import com.masterplanner.ui.tools.impl.modify.strategy.BreakStrategy;
...
public class BreakToolOptionRenderer extends AbstractToolOptionRenderer {
    ...
    public BreakToolOptionRenderer() {
        ...
        this.singleBreakIconId = ImGuiUtils.getTextureId(
            Identifier.of("masterplanner", "textures/gui/tooloptionspanel/break_single.png"));
        this.twoPointBreakIconId = ImGuiUtils.getTextureId(
            Identifier.of("masterplanner", "textures/gui/tooloptionspanel/break_two_point.png"));
    ...
    private float renderUsageInstructions() {
        ...
        height += ImGui.getTextLineHeightWithSpacing();
        ImGui.textWrapped("3. 两点模式下再点击设置第二个打断点");
        height += ImGui.getTextLineHeightWithSpacing();
        ImGui.textWrapped("4. 自动执行打断操作");
        height += ImGui.getTextLineHeightWithSpacing();
        ImGui.popStyleColor();

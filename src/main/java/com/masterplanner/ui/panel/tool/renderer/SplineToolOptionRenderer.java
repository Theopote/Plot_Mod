...
import com.masterplanner.ui.panel.tool.renderer.helpers.SliderRenderHelper;
...
public class SplineToolOptionRenderer extends AbstractToolOptionRenderer implements EventListener {
    ...
    public SplineToolOptionRenderer() {
        ...
        this.splineFitIconId = ImGuiUtils.getTextureId(
            Identifier.of("masterplanner", "textures/gui/tooloptionspanel/spline_fit.png"));
        this.splineControlIconId = ImGuiUtils.getTextureId(
            Identifier.of("masterplanner", "textures/gui/tooloptionspanel/spline_control.png"));

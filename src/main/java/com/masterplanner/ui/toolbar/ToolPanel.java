...
import com.masterplanner.infrastructure.event.tool.ToolSelectedEvent;
...
public class ToolPanel implements UIComponent {
    private static final Logger LOGGER = LoggerFactory.getLogger("MasterPlanner/ToolPanel");
    ...
    private List<ToolGroup> initializeToolGroups() {
        ...
        List<Tool> basicTools = Arrays.asList(
            new Tool(ToolPanelIcons.SELECT, "tool.masterplanner.select", "select"),
            new Tool(ToolPanelIcons.ERASER, "tool.masterplanner.eraser", "eraser")
        );
        groups.add(new ToolGroup("group.masterplanner.basic_tools", basicTools, true));
        
        // 第二组：绘图工具
        List<Tool> drawTools = Arrays.asList(
            new Tool(ToolPanelIcons.LINE, "tool.masterplanner.line", "line"),
            new Tool(ToolPanelIcons.FREEHAND, "tool.masterplanner.freehand", "freedraw"),
            new Tool(ToolPanelIcons.CIRCLE, "tool.masterplanner.circle", "circle"),
            new Tool(ToolPanelIcons.RECTANGLE, "tool.masterplanner.rectangle", "rectangle"),
            new Tool(ToolPanelIcons.SPLINE, "tool.masterplanner.spline", "spline"),
            new Tool(ToolPanelIcons.ELLIPSE, "tool.masterplanner.ellipse", "ellipse"),
            new Tool(ToolPanelIcons.SEMICIRCLE, "tool.masterplanner.semicircle", "semicircle"),
            new Tool(ToolPanelIcons.ARC, "tool.masterplanner.arc", "arc"),
            new Tool(ToolPanelIcons.POLYLINE, "tool.masterplanner.polyline", "polyline"),
            new Tool(ToolPanelIcons.POLYGON, "tool.masterplanner.polygon", "polygon")
        );
        groups.add(new ToolGroup("group.masterplanner.drawing_tools", drawTools, true));
        
        // 第三组：特殊图形
        List<Tool> specialTools = Arrays.asList(
            new Tool(ToolPanelIcons.STAR, "tool.masterplanner.star", "star"),
            new Tool(ToolPanelIcons.SPIRAL, "tool.masterplanner.spiral", "spiral"),
            new Tool(ToolPanelIcons.CATENARY, "tool.masterplanner.catenary", "catenary"),
            new Tool(ToolPanelIcons.SINE_WAVE, "tool.masterplanner.sine", "sine")
        );
        groups.add(new ToolGroup("group.masterplanner.special_tools", specialTools, true));
        
        // 第四组：编辑工具（包含变换和修改功能）
        List<Tool> editTools = Arrays.asList(
            // 变换工具
            new Tool(ToolPanelIcons.MOVE, "tool.masterplanner.move", "move"),
            new Tool(ToolPanelIcons.ROTATE, "tool.masterplanner.rotate", "rotate"),
            new Tool(ToolPanelIcons.SCALE, "tool.masterplanner.scale", "scale"),
            new Tool(ToolPanelIcons.MIRROR, "tool.masterplanner.mirror", "mirror"),
            new Tool(ToolPanelIcons.ALIGN, "tool.masterplanner.align", "align"),
            new Tool(ToolPanelIcons.ARRAY, "tool.masterplanner.array", "array"),
            new Tool(ToolPanelIcons.OFFSET, "tool.masterplanner.offset", "offset"),
            // 修改工具
            new Tool(ToolPanelIcons.BREAK, "tool.masterplanner.break", "break"),
            new Tool(ToolPanelIcons.FILLET, "tool.masterplanner.fillet", "fillet"),

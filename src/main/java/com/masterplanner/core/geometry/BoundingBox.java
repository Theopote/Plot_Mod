...
public class BoundingBox implements IBoundingBox {
     ...
     */
    public static BoundingBox createFromShapes(java.util.List<? extends com.masterplanner.core.model.Shape> shapes) {
        ...
        for (com.masterplanner.core.model.Shape shape : shapes) {

...
public class BezierCurveShape extends Shape implements IExtendableShape {
     ...
     * 计算贝塞尔曲线与直线的相交点
     */
    private List<Vec2d> getBezierLineIntersections(com.masterplanner.core.geometry.shapes.LineShape line) {
        List<Vec2d> intersections = new ArrayList<>();
     ...
     * 计算贝塞尔曲线与圆的相交点
     */
    private List<Vec2d> getBezierCircleIntersections(com.masterplanner.core.geometry.shapes.CircleShape circle) {
        List<Vec2d> intersections = new ArrayList<>();
     ...
     * 这种方法比固定步长采样更精确且高效
     */
    private List<Vec2d> solveBezierLineIntersection(BezierSegment seg, com.masterplanner.core.geometry.shapes.LineShape line) {
        List<Vec2d> intersections = new ArrayList<>();
     ...
     */
    private void findBezierLineIntersectionsRecursive(BezierSegment seg, com.masterplanner.core.geometry.shapes.LineShape line, 
     ...
     */
    private boolean doesSegmentIntersectLine(BezierSegment seg, com.masterplanner.core.geometry.shapes.LineShape line, 
     ...
     */
    private List<Vec2d> solveBezierCircleIntersection(BezierSegment seg, com.masterplanner.core.geometry.shapes.CircleShape circle) {
        List<Vec2d> intersections = new ArrayList<>();
        double tolerance = 1e-6;
     ...
     */
    private void findBezierCircleIntersectionsRecursive(BezierSegment seg, com.masterplanner.core.geometry.shapes.CircleShape circle,
                                                       double tStart, double tEnd, int depth, int maxDepth,
                                                       double tolerance, List<Vec2d> intersections) {
        // 递归终止条件
        if (depth >= maxDepth) {
     ...
     */
    private boolean doesSegmentIntersectCircle(BezierSegment seg, com.masterplanner.core.geometry.shapes.CircleShape circle,
                                             double tStart, double tEnd) {
        // 计算贝塞尔曲线段的边界框
        Vec2d start = seg.getPointAt(tStart);
        Vec2d end = seg.getPointAt(tEnd);
    ...
    public List<Vec2d> getIntersectionsWithPolyline(List<Vec2d> polylinePoints) {
        ...
        for (int i = 0; i < polylinePoints.size() - 1; i++) {
            ...
            com.masterplanner.core.geometry.shapes.LineShape line = 
                new com.masterplanner.core.geometry.shapes.LineShape(p1, p2);

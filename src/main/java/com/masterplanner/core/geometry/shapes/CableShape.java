    ...
    public List<Shape> breakShape(Vec2d firstBreakPoint, Vec2d secondBreakPoint, String breakMode) {
        ...
        try {
            if ("SINGLE_POINT".equals(breakMode)) {
                int segmentIndex = com.masterplanner.core.geometry.GeometryUtils.findSegmentContainingPoint(catenaryPoints, localFirstPoint);
                if (segmentIndex >= 0) {
                ...
                int firstSegment = com.masterplanner.core.geometry.GeometryUtils.findSegmentContainingPoint(catenaryPoints, localFirstPoint);
                int secondSegment = com.masterplanner.core.geometry.GeometryUtils.findSegmentContainingPoint(catenaryPoints, localSecondPoint);

...
public class SnapCalculator {
    ...
    private List<SnapPoint> findGridPoints(Vec2d point) {
        ...
        try {
            ...
            // 从GridManager获取网格设置
            com.masterplanner.ui.grid.GridManager gridManager = com.masterplanner.ui.grid.GridManager.getInstance();
            ...
            // 获取网格设置
            com.masterplanner.ui.grid.GridSettings gridSettings = gridManager.getSettings();

package com.masterplanner.core.state;
...
import com.masterplanner.core.model.Project;
import com.masterplanner.core.model.Shape;
import com.masterplanner.core.selection.Selection;
...
import com.masterplanner.infrastructure.event.command.CommandExecutedEvent;
import com.masterplanner.infrastructure.event.shapes.ShapesRemovedEvent;
...
import com.masterplanner.core.layer.LayerEventSystem;
import com.masterplanner.infrastructure.event.base.Event;
import com.masterplanner.core.spatial.SpatialIndex;
import com.masterplanner.core.spatial.QuadtreeSpatialIndex;
...
public class AppState implements IAppState {
    private static final Logger LOGGER = LoggerFactory.getLogger("MasterPlanner/AppState");
    ...
    public void initializePluginSystem() {
        if (this.pluginLoader == null) {
            ...
            // 创建插件加载器
            this.pluginLoader = new com.masterplanner.core.plugin.EmptyPluginLoader();

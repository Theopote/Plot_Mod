...
- [BuildingBenchmarkBaseline.md](BuildingBenchmarkBaseline.md) — D01–D05 片区 Massing 性能基线
- [task-assignments/](task-assignments/) — 历史与进行中的功能任务书（自原 `taskassignment/` 迁入）；土方近期见 [EarthworkPlugin_产品收敛与玩家主路径.md](task-assignments/EarthworkPlugin_产品收敛与玩家主路径.md)
